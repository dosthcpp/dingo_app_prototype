import 'package:dingoprototype/components/appbar.dart';
import 'package:dingoprototype/components/bottom_navigator_bar.dart';
import 'package:dingoprototype/constants.dart';
import 'package:flutter/material.dart';
import 'package:dingoprototype/data/user_database.dart';
...
//                                  snapshot.data[userDataItem[5]].toString(); // 방이름
                              final String childName = snapshot
                                  .data[userDataItem[2]]
                                  .toString(); // 원아 이름
                              final String className = snapshot
                                  .data[userDataItem[6]]
                                  .toString(); // 반 이름
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        for (var message in messages) {
          final String className = message.data['className'];
          final String childName = message.data['childName'];
          final String messageText =
              message.data['text']; // messages from FirebaseData
          final String messageSender = message.data['sender'];
          final DateTime time = DateTime.parse(message.data['time']);
