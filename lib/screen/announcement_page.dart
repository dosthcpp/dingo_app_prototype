...
class _AnnouncementPageState extends State<AnnouncementPage> {
  ...
  List<_FoodMenuCard> _foodMenuCardList = [
    ...
    _FoodMenuCard(
      ...
      date: DateTime(2020, 05, 28),
    ),
  ];

  List<_AlertCard> _alertCardList = [
    _AlertCard(
      alertType: "가정통신문",
      className: "희망유치원 희망반",
      date: DateTime(2020, 05, 30),
      title: "2020년 3월 봄 소풍 중단 안내",
      content:
          "2020년 3월 일정에 있던 봄 소풍이 최근 심해진 코로나 바이러스로 인하여 아이들의 건강을 해칠 우려가 있다고 생각되어 취소되었습니다.\n\n코로나 바이러스에 관련된 예방법과 대처법에 관하여 정부에서…",
      fileName: "코로나 19 관련 질병대책본부 지침 안내.hwp",
    ),
    _AlertCard(
      alertType: "알림장",
      className: "희망유치원 희망반",
  ...
  void initState() {
    super.initState();
    _cardList = _announcementCardList;
  }
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          buildLocalMenuPanel(
                              0, "알림장", 'announce_card', _announcementCardList),
                          buildLocalMenuPanel(
                              1, "식단표", 'food_menu_card', _foodMenuCardList),
                          buildLocalMenuPanel(
                              2, "가정통신문", 'alert_card', _alertCardList),
                          buildLocalMenuPanel(
                              3, "일정표", 'calendar_card', _calendarCard),
                        ],
                      ),
                    ),
                    Padding(
  ...
  GestureDetector buildLocalMenuPanel(
      int menuNumber, String title, String imageName, List<Widget> renderList) {
